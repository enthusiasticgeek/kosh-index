...
|---|---|---|---|
| MAINT-1 | **WCET (`#[wcet(cycles=N)]`) coverage backfill** — in progress, package-by-package. | large, multi-session | **4/12 done (vani-complex, vani-vectorcalc, vani-algebra, vani-discrete)** |
