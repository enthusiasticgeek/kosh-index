...
10. ~~ML tier~~ ✅ CLOSED 2026-08-16, independent of the symbolic tier (depended only on the numeric tier, which was done). **vani-ml** phased breakdown (v0.1.0 classical ML → v0.2.0 data utilities → v0.3.0 autodiff core → v0.4.0 layers/activations/losses → v0.5.0 optimizers → v0.6.0+ training-loop utilities/stretch) scoped 2026-07-25, all phases shipped and published, see [above](#planned-ml-tier-scoped-2026-07-25). The symbolic tier is the only work left anywhere in this document.
